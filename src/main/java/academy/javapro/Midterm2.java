...
// Necessary imports for collections and functional interfaces
...
public class Midterm2 {
    ...
    public static <T, S, R> List<R> mergeCollections(
        ...
        if (firstCollection.size() != secondCollection.size()) {
            ...
            // Loop through the arrays and merge element-wise
    ...
    public static <T, S, R> List<R> zipCollections(
        ...
        // Initialize the 'result' list with an initial capacity set to the minimum size
